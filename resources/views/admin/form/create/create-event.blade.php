		...
		<div class="container-create">
			...
			<form class="create-form" action="" method="post">
				...
				<div class="wrap-input1">
					<input class="input1" type="text" name="event_name" placeholder="Nama Event">
					<span class="shadow-input1"></span>
				</div>
                <div class="wrap-input1">
					<input class="input1" type="text" name="tanggal_event" placeholder="Tanggal">
					<span class="shadow-input1"></span>
				</div>
                <div class="wrap-input1">
					<input class="input1" type="text" name="jam_event" placeholder="Jam ">
					<span class="shadow-input1"></span>
				</div>
