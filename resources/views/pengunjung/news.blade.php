...
@section('title' , 'News | Hotel')

@section('container')
<!-- Hero Section Begin -->
<section class="hero-section set-bg" data-setbg="img/news-bg.jpg">
    <div class="hero-text">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="page-nav">
                <a href="{{ url('/room') }}" class="left-nav"><i class="lnr lnr-arrow-left"></i> Rooms</a>
